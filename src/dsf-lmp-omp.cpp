...
int dsf_lmp_omp(int argc, char* argv[], optpara opts, string atom_conc, int num_omp)
{  
  /***********************************/
  ...
  if(wave == "100" && opts.polytype == "3H") {
    ...
    dir_t1[0] = 0.0; dir_t1[1] = 3.0; dir_t1[2] = 0.0;
    dir_t2[0] = 0.0; dir_t2[1] = 0.0; dir_t2[2] = 3.0;
  }
    ...
    dir_t1[0] = 0.0; dir_t1[1] = 0.0; dir_t1[2] = 0.0;
    dir_t2[0] = 0.0; dir_t2[1] = 0.0; dir_t2[2] = 0.0;
  }
  else if(wave == "220") {
    dir_la[0] = 0.0; dir_la[1] = 0.0; dir_la[2] = 0.0;
